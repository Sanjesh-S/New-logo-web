...
const nextConfig = {
  ...
  // Skip API routes completely during static export
  // They will be handled by Firebase Functions
  async rewrites() {
    // In static export, API routes are not generated
    // This prevents Next.js from trying to process them
    return []
  },
  images: {
