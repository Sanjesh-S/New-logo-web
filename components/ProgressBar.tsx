            ...
            return (
              ...
              >
                <div className="relative flex items-center justify-center w-full">
                  ...
                  {/* Step Circle */}
                  <motion.div
                    className={`relative z-10 w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm transition-all duration-300 ${
                      isCompleted
                        ? 'bg-gradient-to-br from-brand-blue-600 to-brand-lime text-white shadow-lg shadow-brand-lime/30'
                        : isCurrent
                        ? 'bg-gradient-to-br from-brand-blue-600 to-brand-lime text-white shadow-lg shadow-brand-lime/30 ring-4 ring-brand-lime/20'
