        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            ...
            <motion.button
              ...
              className={`p-4 rounded-xl border-2 text-left transition-all flex flex-col items-center text-center gap-3 ${
            ...
            >
              <div className="w-28 h-28 sm:w-32 sm:h-32 flex-shrink-0 flex items-center justify-center bg-transparent">
                <img
