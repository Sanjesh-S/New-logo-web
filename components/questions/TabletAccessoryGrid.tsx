...
import { Zap, Box, Cable, FileText, Tablet, Keyboard } from 'lucide-react'

interface TabletAccessoryGridProps {
  value?: string[]
  onChange: (value: string[]) => void
}

const tabletAccessories = [
  ...
  { id: 'case', label: 'Tablet Case', icon: Tablet },
  { id: 'keyboard', label: 'Keyboard (if applicable)', icon: Keyboard },
  { id: 'stylus', label: 'Stylus/Pencil (if applicable)', icon: Tablet },
]

export default function TabletAccessoryGrid({ value = [], onChange }: TabletAccessoryGridProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
        {tabletAccessories.map((accessory) => {
